...
"rooms": [
{"id": "du", "image": "dueling-room", "name": "Dueling Room", "category": "Barracks", "prereq": null, "capacity": -10, "energy": -10, "maxnum": null, "floor": 0, "ceil": 20,
	"bounds": [
...
{"id": "or", "image": "oracle2", "name": "Oracle", "category": "Lab", "prereq": null, "capacity": -2, "energy": -5, "maxnum": null, "floor": -8, "ceil": 12,
	"bounds": [
...
{"id": "le", "image": "energy-lab", "name": "Energy Lab", "category": "Lab", "prereq": "or", "capacity": -2, "energy": -5, "maxnum": null, "floor": 0, "ceil": 16,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Polymer Bundle", "costs": [350, 1050, 3500, 10500, 35000]},
		{"resource": "Forma", "costs": [1, 1, 2, 5, 15]}]},
{"id": "lc", "image": "chem-lab", "name": "Chem Lab", "category": "Lab", "prereq": "or", "capacity": -2, "energy": -5, "maxnum": null, "floor": -12, "ceil": 16,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Polymer Bundle", "costs": [350, 1050, 3500, 10500, 35000]},
		{"resource": "Forma", "costs": [1, 1, 2, 5, 15]}]},
{"id": "lb", "image": "bio-lab", "name": "Bio Lab", "category": "Lab", "prereq": "or", "capacity": -2, "energy": -5, "maxnum": null, "floor": 0, "ceil": 12,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Polymer Bundle", "costs": [350, 1050, 3500, 10500, 35000]},
		{"resource": "Forma", "costs": [1, 1, 2, 5, 15]}]},
{"id": "lo", "image": "orokin-lab", "name": "Orokin Lab", "category": "Lab", "prereq": "or", "capacity": -2, "energy": -5, "maxnum": null, "floor": -12, "ceil": 24,
	"bounds": [
...
{"id": "lt", "image": "tenno2-lab", "name": "Tenno Lab", "category": "Lab", "prereq": "or", "capacity": -2, "energy": -5, "maxnum": null, "floor": 0, "ceil": 8,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Polymer Bundle", "costs": [350, 1050, 3500, 10500, 35000]},
		{"resource": "Forma", "costs": [1, 1, 2, 5, 15]}]},
{"id": "oc", "image": "obstacle-course", "name": "Obstacle Course", "category": "Barracks", "prereq": null, "capacity": -10, "energy": -10, "maxnum": null, "floor": -38, "ceil": 24,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Forma", "costs": [1, 1, 2, 5, 15]}]},
{"id": "oa", "image": "obstacle-course-architect", "name": "Obstacle Course Architect", "category": "Barracks", "prereq": null, "capacity": 0, "energy": -2, "maxnum": 3, "floor": 0, "ceil": 48,
	"bounds": [
...
{"id": "ce", "image": "elevator-bottom", "name": "Elevator", "category": "Connectors", "prereq": null, "capacity": -2, "energy": -2, "maxnum": null, "floor": -24, "ceil": 16,
	...
	"resources": [
		...
		{"resource": "Nano Spores", "costs": [1200, 3600, 12000, 36000, 120000]},
		{"resource": "Forma", "costs": [1, 1, 1, 1, 5]}]},
{"id": "re", "image": "reactor", "name": "Reactor", "category": "Energy", "prereq": null, "capacity": -5, "energy": 25, "maxnum": null, "floor": -32, "ceil": 26,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Forma", "costs": [1, 1, 1, 1, 5]}]},
{"id": "b1", "image": "barracks", "name": "Shadow Barracks", "category": "Barracks", "prereq": null, "capacity": -1, "energy": -1, "maxnum": 1, "floor": -8, "ceil": 12,
	"bounds": [
		{"x1": -16, "y1": -18, "x2": 16, "y2": 18, "floor": -8, "ceil": 12}],
	"doors": [
		{"x": 0, "y": 18, "floor": 0, "outx": 0, "outy": 1}],
	"resources": [
		{"resource": "Credits", "costs": [100, 0, 0, 0, 0]},
		{"resource": "Alloy Plate", "costs": [150, 0, 0, 0, 0]},
		{"resource": "Ferrite", "costs": [600, 0, 0, 0, 0]},
		{"resource": "Rubedo", "costs": [300, 0, 0, 0, 0]},
		{"resource": "Forma", "costs": [1, 0, 0, 0, 0]}]},
{"id": "b2", "image": "barracks", "name": "Storm Barracks", "category": "Barracks", "prereq": "b1", "capacity": -1, "energy": -1, "maxnum": 1, "floor": -8, "ceil": 12,
	"bounds": [
		{"x1": -16, "y1": -18, "x2": 16, "y2": 18, "floor": -8, "ceil": 12}],
	"doors": [
		{"x": 0, "y": 18, "floor": 0, "outx": 0, "outy": 1}],
	"resources": [
		{"resource": "Credits", "costs": [0, 3000, 0, 0, 0]},
		{"resource": "Alloy Plate", "costs": [0, 450, 0, 0, 0]},
		{"resource": "Ferrite", "costs": [0, 1800, 0, 0, 0]},
		{"resource": "Rubedo", "costs": [0, 900, 0, 0, 0]},
		{"resource": "Forma", "costs": [0, 1, 0, 0, 0]}], "unverified": true},
{"id": "b3", "image": "barracks", "name": "Mountain Barracks", "category": "Barracks", "prereq": "b2", "capacity": -1, "energy": -1, "maxnum": 1, "floor": -8, "ceil": 12,
	"bounds": [
		{"x1": -16, "y1": -18, "x2": 16, "y2": 18, "floor": -8, "ceil": 12}],
	"doors": [
		{"x": 0, "y": 18, "floor": 0, "outx": 0, "outy": 1}],
	"resources": [
		{"resource": "Credits", "costs": [0, 0, 10000, 0, 0]},
		{"resource": "Alloy Plate", "costs": [0, 0, 1500, 0, 0]},
		{"resource": "Ferrite", "costs": [0, 0, 6000, 0, 0]},
		{"resource": "Rubedo", "costs": [0, 0, 3000, 0, 0]},
		{"resource": "Forma", "costs": [0, 0, 3, 0, 0]}], "unverified": true},
{"id": "b4", "image": "barracks", "name": "Moon Barracks", "category": "Barracks", "prereq": "b3", "capacity": -1, "energy": -1, "maxnum": 1, "floor": -12, "ceil": 12,
	"bounds": [
		{"x1": -16, "y1": -18, "x2": 16, "y2": 18, "floor": -8, "ceil": 12}],
	"doors": [
		{"x": 0, "y": 18, "floor": 0, "outx": 0, "outy": 1}],
	"resources": [
		{"resource": "Credits", "costs": [0, 0, 0, 100000, 0]},
		{"resource": "Alloy Plate", "costs": [0, 0, 0, 15000, 0]},
		{"resource": "Ferrite", "costs": [0, 0, 0, 60000, 0]},
		{"resource": "Rubedo", "costs": [0, 0, 0, 30000, 0]},
		{"resource": "Forma", "costs": [0, 0, 0, 25, 0]}], "unverified": true},
{"id": "gs", "image": "small-garden", "name": "Small Garden", "category": "Garden", "prereq": null, "capacity": -10, "energy": -6, "maxnum": null, "floor": 0, "ceil": 20,
	"bounds": [
		{"x1": -16, "y1": -16, "x2": 16, "y2": 16, "floor": 0, "ceil": 20}],
	"doors": [
		{"x": 0, "y": 16, "floor": 0, "outx": 0, "outy": 1},
...
{"id": "gl", "image": "large-garden", "name": "Large Garden", "category": "Garden", "prereq": null, "capacity": -15, "energy": -8, "maxnum": null, "floor": 0, "ceil": 20,
	"bounds": [
...
{"id": "ob", "image": "observatory", "name": "Observatory", "category": "Barracks", "prereq": null, "capacity": -2, "energy": -5, "maxnum": null, "floor": -40, "ceil": 56,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Forma", "costs": [1, 1, 2, 5, 15]}], "unverified": true},
{"id": "th", "image": "temple-of-honor", "name": "Temple Of Honor", "category": "Barracks", "prereq": null, "capacity": -2, "energy": -5, "maxnum": null, "floor": 0, "ceil": 24,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Alloy Plate", "costs": [150, 450, 1500, 4500, 15000]},
		{"resource": "Forma", "costs": [1, 1, 1, 3, 10]}], "unverified": true},
{"id": "h1", "image": "clan-hall", "name": "Clan Hall", "category": "Hall", "prereq": null, "capacity": 100, "energy": 5, "maxnum": 1, "floor": -12, "ceil": 24,
	"bounds": [
	...
	"doors": [
		...
		{"x": 0, "y": -32, "floor": 0, "outx": 0, "outy": -1}],
	"resources": []},
{"id": "h2", "image": "clan-great-hall", "name": "Clan Great Hall", "category": "Hall", "prereq": "h1", "capacity": 200, "energy": -2, "maxnum": 1, "floor": -12, "ceil": 24,
	"bounds": [
		{"x1": -18, "y1": -32, "x2": 18, "y2": 32, "floor": -12, "ceil": 24}],
	"doors": [
		{"x": 0, "y": 32, "floor": 0, "outx": 0, "outy": 1},
...
{"id": "h3", "image": "clan-greater-hall", "name": "Clan Greater Hall", "category": "Hall", "prereq": "h2", "capacity": 200, "energy": -2, "maxnum": 1, "floor": -12, "ceil": 24,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Nano Spores", "costs": [300, 900, 3000, 9000, 30000]},
		{"resource": "Forma", "costs": [1, 1, 3, 8, 25]}]},
{"id": "h4", "image": "clan-grand-hall", "name": "Clan Grand Hall", "category": "Hall", "prereq": "h3", "capacity": 200, "energy": -2, "maxnum": 1, "floor": -12, "ceil": 32,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Nano Spores", "costs": [300, 900, 3000, 9000, 30000]},
		{"resource": "Forma", "costs": [1, 1, 3, 8, 25]}]},
{"id": "h5", "image": "clan-grandest-hall", "name": "Clan Grandest Hall", "category": "Hall", "prereq": "h4", "capacity": 200, "energy": -2, "maxnum": 1, "floor": -12, "ceil": 32,
	"bounds": [
		{"x1": -32, "y1": -32, "x2": 32, "y2": 32, "floor": -12, "ceil": 32}],
	"doors": [
		{"x": 0, "y": 32, "floor": 0, "outx": 0, "outy": 1},
	...
	"resources": [
		...
		{"resource": "Nano Spores", "costs": [300, 900, 3000, 9000, 30000]},
		{"resource": "Forma", "costs": [1, 1, 3, 8, 25]}]},
{"id": "hi", "image": "inspiration-hall", "name": "Inspiration Hall", "category": "Hall", "prereq": null, "capacity": 100, "energy": -1, "maxnum": 3, "floor": -12, "ceil": 48,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Forma", "costs": [1, 1, 3, 8, 25]}]},
{"id": "dd", "image": "dry-dock", "name": "Dry Dock", "category": "Barracks", "prereq": null, "capacity": -20, "energy": -6, "maxnum": 1, "floor": -80, "ceil": 200,
	"bounds": [
	...
	"resources": [
		...
		{"resource": "Forma", "costs": [1, 1, 3, 8, 25]}]},
{"id": "cr", "image": "crimson-branch", "name": "Crimson Branch", "category": "Barracks", "prereq": null, "capacity": -2, "energy": -4, "maxnum": null, "floor": 0, "ceil": 30,
	"bounds": [
